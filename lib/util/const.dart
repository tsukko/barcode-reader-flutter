...
//    var domain = "pmda.go.jp";
  static const baseUrl = "https://www.pmda.go.jp";
  static const searchDir = "/PmdaSearch/iyakuSearch/";
...
//      'howtoMatchRadioValue': '1',
  ...
  static String addBaseUrl(String pathUrl) {
  ...
  static Map<String, String> getBodyGs1code(String code) {
